        ...
        <div>
            ...
            <div className="container info">
                ...
                <div style={{ textAlign: 'center' }}>
                    <a href={`https://${strFacebook}`}><FontAwesomeIcon className="social fb" icon={faFacebook} /></a> <a href={`https://${strTwitter}`}><FontAwesomeIcon className="social tw" icon={faTwitter} /></a>  <a href={`https://${strYoutube}`}><FontAwesomeIcon className="social yt" icon={faYoutube} /></a>
                </div>
            </div></div>
    );
};
